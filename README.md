# perfChecker - Performance-Focused Static Analyzer for Go

[![Go Version](https://img.shields.io/badge/Go-1.21%2B-00ADD8?style=flat&logo=go)](https://go.dev)
[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Test Coverage](https://img.shields.io/badge/coverage-66.8%25-yellow)](https://github.com/SergeiSkv/perfChecker)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/SergeiSkv/perfChecker/pulls)

> **Performance analyzer that finds issues standard linters miss**

**perfChecker** - A high-performance static analyzer for Go that focuses on detecting performance bottlenecks, algorithmic complexity issues, and AI-generated anti-patterns.

## 🎯 What It Does

perfChecker identifies performance issues that standard linters don't catch:
...
```bash
go install github.com/SergeiSkv/perfChecker@latest
```
...
# With configuration
./perfChecker --config .perfchecker.yaml .

# Enable cache for faster subsequent runs
./perfChecker --enable-cache .
